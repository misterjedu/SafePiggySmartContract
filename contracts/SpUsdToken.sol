...
contract SpUsdToken is ERC20 {
    
    constructor() ERC20("SpUsd Token", "SPUSD") {
   ...
   function approveAddress(address client,address spender, uint256 amount) public returns (bool) {
        _approve(client, spender, amount);
        return true;
    }
